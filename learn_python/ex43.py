...
class CentralCorridor(Scene):
    ...
    def enter(self):
        ...
        a Gothon jump out, red scaly skin, dark grimy teeth, and eval clown costume
        ...
        if action == "shoot!":
            ...
            The Gothon stops, tires not to laugh, then busts out laughing and can't move.
            While he's laughing you ran up and shoot him square in the head
...
class TheBridge(Scene):
    ...
    def enter(self):
        ...
        if action == "throw the bomb":
            ...
            As you die you see another Gothon rantically try to disarm
